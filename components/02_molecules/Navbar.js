...
export default function Navbar() {
  ...
  useEffect(() => {
    function handleResize() {
      const menu_button = document.querySelector(`.${styles.menu_button}`);
          ...
          <div className={styles.popup}>
            ...
            <div className={styles.popup_body}>
              ...
              <div className={styles.popup_body_right}>
                ...
                <div>
                  If you are interested in partnering with TUM.ai as a sponsor,{" "}
                  <b>
                    Makeathon challenge-setter, Industry project partner,
                    Workshop host
                  </b>
                  , etc. please reach out to our &quot;Partners & Sponsors&quot;
                  department.{" "}
                </div>
              </div>
            </div>
          ...
          {mobileMenuActive && (
            <div className={styles.navbar_responsive}>
              <div className={styles.links}>
                <Link href="https://aielab.tum-ai.com/">AI E-Lab</Link>
                <Link href="https://makeathon.tum-ai.com/">Makeathon</Link>
                <Link href="/industry">Industry Projects</Link>
                <Link href="/partners">Partners</Link>
                <Link href="/members">Members</Link>
                <Link href="https://join-us.tum-ai.com/">Join us</Link>
                <DropdownLinks
                  title={
                    <div
                      style={{
