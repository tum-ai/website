        ...
        <Dialog.Portal>
          <Dialog.Overlay asChild>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 flex cursor-pointer items-center bg-purple-950/80 backdrop-blur-lg"
            />
          </Dialog.Overlay>

          <Dialog.Content className="container fixed left-[50%] top-[50%] mx-auto max-w-lg translate-x-[-50%] translate-y-[-50%] text-white mt-24">
            <nav className="px-4 sm:py-4">
              <ul className="flex flex-col sm:space-y-2">
                {links.map(({ href, text }) => (
                  <Link
                    key={text}
                    className="w-full rounded-2xl px-4 py-2 text-lg sm:text-2xl duration-500 hover:bg-purple-500/80"
                    href={href}
              ...
              <hr className="my-1 sm:my-8 border-b-2" />
  ...
  return (
    ...
    >
      ...
      <div className="px-8 py-4">
        <div
          className={cx(
            "container relative mx-auto flex flex-row justify-between"
          )}
        >
  ...
  return (
    <Link href={"/"}>
      ...
      >
        ...
        <g className={cx("duration-500", scrolled && !navOpen && "opacity-0")}>
